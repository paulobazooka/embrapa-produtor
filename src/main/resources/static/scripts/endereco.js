...
function buscarEstados() {
    ...
    requisicaoEstados.open(tipo, 'https://estados-cidades.herokuapp.com/api/v1/estado', assincrona);
...
// Função para buscar as cidades dependendo do estado escolhido
    function buscarCidades() {
        ...
        requisicaoCidades.open(tipo, 'https://estados-cidades.herokuapp.com/api/v1/cidade/' + idEstado, assincrona);
